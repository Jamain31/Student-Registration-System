    ...
    <div class="row">
      <div class="col-lg-4">
        ...
        <nav class="list-group">
          ...
          <a class="list-group-item" href="students.php"><i class="fa fa-map"></i>Registered Students</a>
        </nav>
      </div>
      <div class="col-lg-8">
        <table class="table table-bordered">
          <thead>
            <tr>
              <th>Username: adminassistant</th>
              <th class="text-center"><a class="btn btn-sm btn-outline-danger" href="logout.php">Logout</a></th>
            </tr>
          </thead>
          <!-- Add any additional content for the admin assistant profile here -->
        </table>
      </div>
    </div>
  </div>
