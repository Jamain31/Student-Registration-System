...
$sqlRegisteredCourses = "SELECT c.courseName FROM tblstudentcourses sc
...
$registeredCourses = $stmtRegisteredCourses->fetchAll(PDO::FETCH_COLUMN);
?>
...
<div class="container">
    ...
    <div class="row mt-3">
        <div class="col-md-12 text-center">
            <!-- Display Registered Courses Section -->
            <div class="card">
                <p class="title">Registered Courses</p>
